...
public class QueueConsumer2 {
    ...
    final String QUEUE_NAME = "Q3/tutorial";
            ...
            public void onMessage(Message message) {
                try {
                    if (message instanceof TextMessage) {
                        System.out.printf(" C2 TextMessage received: '%s'%n", ((TextMessage) message).getText());
                    } else {
                        System.out.println(" C2 Message received.");
                    }

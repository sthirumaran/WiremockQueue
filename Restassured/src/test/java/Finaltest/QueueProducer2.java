...
public class QueueProducer2 {
    ...
    final static String QUEUE_NAME = "Q3/tutorial";
    
   

    public static void run(String inpMessage) throws Exception {
    	
    	System.out.println("Retrieveed message from consumer1"+ inpMessage);
      ...
      //  System.out.printf("Connected with username '%s'.%n", solaceUsername);
        ...
        TextMessage message = session.createTextMessage("Producer2 message"+inpMessage);

...
import Finaltest.QueueProducer2;
...
public class QueueConsumer {
    ...
    final String QUEUE_NAME = "Q4/tutorial";
        ...
        messageConsumer.setMessageListener(new MessageListener() {
            ...
            public void onMessage(Message message) {
                try {
                    ...
                    System.out.printf("Message Content:%n%s%n   ", ((TextMessage) message).getText()); 
                    
                   String URL1 = (((TextMessage) message).getText());
                   
                   System.out.printf(URL1);
                    
                 //   String URL = "http://localhost:8080/api/mytest2";
                    
                	Response response = given().with().get(URL1);
                    ...
                    try {
                    	QueueProducer2.run(((TextMessage) message).getText());
					} catch (Exception e) {
